...
1. **GET FREE SPIN ON MRBEAN9 🎰** - Shows free spin promotional information with inline buttons:
...
- `TELEGRAM_CHANNEL` (Optional) - Telegram channel URL (default: `https://t.me/mrbean9`)
- `FREE_SPIN_URL` (Optional) - Free spin promotion URL (default: `https://mrbean9.com/RFIMRBEAN9BOT9`)
- `FREE_CREDIT_URL` (Optional) - Free credit promotion URL (default: `https://mrbean9.com/RFIMRBEAN9BOT9`)
...
```bash
docker build -t mrbean9-bot .
docker run -d --env-file .env mrbean9-bot
```
...
2. Create volume: `fly volumes create mrbean9_bot_data --size 1 --region sin`
...
**Mrbean9 Promo Bot** - Making marketing simpler! 🚀
